...
public class GoRunCallable extends MasterToSlaveFileCallable<Build> {
    ...
    public GoRunCallable(String path, String goCmdArgs, String module, Log logger, EnvVars env) {
        ...
        this.logger = logger;
        this.env = env;
        this.artifactoryManagerBuilder = null;
    }

    public void setResolverDetails(ArtifactoryManagerBuilder artifactoryManagerBuilder, String resolutionRepository, String username, String password) {
    ...
    public Build invoke(File file, VirtualChannel channel) throws IOException, InterruptedException {
        ...
        return new GoRun(goCmdArgs, packagePath, module, artifactoryManagerBuilder, resolutionRepository, resolverUsername, resolverPassword, logger, env).execute();
    }
}