 ...
 * overriding the default resolver credentials in the global config.<br/> To be used mostly for builder configurations.
 *
 * @author Noam Y. Tenne
 */
public interface ResolverOverrider {
    ...
    /**
     * Indicates whether the represented builder is configured to override the default resolution credentials configured
    ...
    String getResolverCredentialsId();
}